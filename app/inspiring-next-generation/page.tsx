...
export default function InspiringNextGeneration() {
    return (
            ...
            <div className="flex-grow flex flex-col py-6 md:py-10 lg:py-12 pl-6 md:pl-12 lg:pl-20 z-10">
                ...
                <main className="flex-grow flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-8 py-2 md:py-4 relative">
                    <div className="w-full lg:w-3/5 flex flex-col justify-center z-10">
                        <h1 className="text-[7vw] md:text-[5vw] lg:text-[5rem] font-bold leading-[1.1] tracking-[-0.03em] mb-4 md:mb-8 lg:mb-10 uppercase">
                            Inspiring the <br />Next Generation <br />of Global Citizens
                        </h1>
                        <p className="text-white/80 text-xs md:text-lg leading-[1.6] max-w-xl font-normal">
                            From international schools to elite universities and global banking floors, Julio
                            Herrera Velutini’s life is a mighty example for young professionals today. It teaches
                            that education is beyond exams and diplomas: it’s about resilience, curiosity, and the
                            willingness to turn learning into leadership which serves both industry and society.
                        </p>
                    </div>
                ...
                <footer className="flex justify-between items-center mt-auto pt-4 md:pt-6 pr-6 md:pr-12 lg:pr-20 relative z-20">
                    ...
                    <div className="flex items-center gap-8">
                        <Link href="/lifelong-learning" className="flex items-center group cursor-pointer rotate-180">
                        ...
                        <Link href="/" className="flex items-center group cursor-pointer">
                            <span className="text-[10px] uppercase tracking-widest font-bold border-b border-white pb-1 group-hover:pr-2 transition-all">Back to Start</span>
                        </Link>
                    </div>
                </footer>
            </div>
